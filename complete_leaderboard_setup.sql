...
-- ========================================
-- PART 1: LEADERBOARD TABLE SETUP
-- ========================================
...
-- ========================================
-- PART 3: LEADERBOARD SCORES DATA
-- ========================================
...
SELECT '🎉 LEADERBOARD SETUP COMPLETE! 🎉' AS status,
       'Top 40 airlines with realtime leaderboard are ready!' AS message,
       'Your Flutter app will now show the realtime leaderboard' AS next_step;
