-- Top 40 Airlines Data for Leaderboard
-- This script populates the airlines table and leaderboard_scores with realistic data
-- Run this after the main leaderboard setup script

-- 1. Insert/Update top 40 airlines in the airlines table
...
-- 2. Insert realistic leaderboard scores for top 40 airlines
...
-- 3. Insert Wi-Fi Experience scores (varying by airline type)
INSERT INTO leaderboard_scores (airline_id, score_type, score_value, updated_at) VALUES
...
-- 5. Insert Food and Drink scores
INSERT INTO leaderboard_scores (airline_id, score_type, score_value, updated_at) VALUES
...
-- 7. Show sample of top 10 airlines by overall score
SELECT 
