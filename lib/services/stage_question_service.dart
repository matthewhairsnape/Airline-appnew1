  ...
  static const Map<FeedbackStage, List<StageQuestion>> _stageQuestions = {
    FeedbackStage.preFlight: [
      StageQuestion(
        ...
        title: 'Positive (What they liked)',
        subtitle: 'Choose what you liked about your pre-flight experience',
      ...
      StageQuestion(
        ...
        title: 'Negative (What could be improved)',
        subtitle: 'Choose what could be better about your pre-flight experience',
