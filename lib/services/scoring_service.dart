...
class ScoringService {
  ...
  static const double GLOBAL_AVERAGE = 3.5; // Global average across all airlines
  ...
  static ScoringResult calculateOverallScore({
    ...
    if (postFlightScore != null) {
      ...
      if (phasesCompleted == 2) {
        ...
        if (preFlightScore != null && inFlightScore != null) {
          ...
          scores = {'pre-flight': preFlightScore, 'post-flight': postFlightScore};
        } else if (inFlightScore != null) {
      ...
      if (catchUpScore != null) {
        ...
        if (preFlightScore != null && inFlightScore != null) {
          ...
          weights = {'pre-flight': PRE_FLIGHT_WEIGHT, 'catch-up': IN_FLIGHT_WEIGHT + POST_FLIGHT_WEIGHT};
          scores = {'pre-flight': preFlightScore, 'catch-up': catchUpScore};
        } else if (inFlightScore != null) {
          // In + Catch-up for Pre + Post
          weights = {'in-flight': IN_FLIGHT_WEIGHT, 'catch-up': PRE_FLIGHT_WEIGHT + POST_FLIGHT_WEIGHT};
    ...
    String calculationMethod = _getCalculationMethod(phasesCompleted, scores.keys.toList(), catchUpScore != null);
  ...
  static String _getCalculationMethod(int phasesCompleted, List<String> phases, bool usedCatchUp) {
