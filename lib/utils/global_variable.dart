...
const accessKeyId = String.fromEnvironment('AWS_ACCESS_KEY_ID', defaultValue: '');
const secretAccessKey = String.fromEnvironment('AWS_SECRET_ACCESS_KEY', defaultValue: '');
