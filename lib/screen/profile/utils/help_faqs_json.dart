List<Map<String, dynamic>> helpAndFaqsList = [
  {
  ...
  },
  {
    ...
    'contents':
        'For any issues or inquiries, users can reach out to our support team via the app or through our official website for assistance.'
  },
  {
    'topic': 'Feedback Mechanism',
    'contents':
        'Users can provide feedback on their experience within the app, helping us improve the platform and tailor it to user needs.'
  },
  {
    'topic': 'App Store Deployment',
    'contents':
        'The platform is designed for smooth deployment to the App Store and Google Play, ensuring easy access for users on both iOS and Android devices.'
  },
];
