...
/// Simple example screen demonstrating basic data flow functionality
class SimpleDataFlowExampleScreen extends StatefulWidget {
  const SimpleDataFlowExampleScreen({super.key});

  @override
  State<SimpleDataFlowExampleScreen> createState() => _SimpleDataFlowExampleScreenState();
}

class _SimpleDataFlowExampleScreenState extends State<SimpleDataFlowExampleScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Simple Data Flow Example'),
          ...
          children: [
            ...
            Row(
              children: [
                ...
                const SizedBox(width: 16),
                _buildStatusIndicator('Channels', health['active_channels'] > 0),
              ],
            ),
            const SizedBox(height: 8),
            Text(
